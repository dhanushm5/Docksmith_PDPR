...
`docksmith-macos` is the macOS-oriented Docksmith variant that uses Docker Desktop for setup and helper workflows.
...
Build the helper image and install the base image through Docker Desktop:
